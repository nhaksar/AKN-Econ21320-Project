...
stargazer(mod_nolag, mod_1lag, mod_2lag, mod_3lag, mod_4lag, mod_5lag, 
          ...
          covariate.labels = c("Total layoffs this year",
                               ...
                               "Total layoffs 4 years ago",
                               "Total layoffs 5 years ago"),
          title="Total alcohol and drug deaths regressed on total layoffs with Per Capita Incomecounty fixed effects only",
          digits=6,
          column.sep.width = "-4pt",
          label="tb:total-fe")
...
stargazer(mod_nolag, mod_1lag, mod_2lag, mod_3lag, mod_4lag, mod_5lag, 
          ...
          covariate.labels = c("Total layoffs this year",
                               ...
                               "Total layoffs 4 years ago",
                               "Total layoffs 5 years ago"),
          title="Total alcohol and drug deaths regressed on total layoffs with Per Capita Income and year fixed effects only",
          digits=6,
          column.sep.width = "-4pt",
          label="tb:total-fe")
